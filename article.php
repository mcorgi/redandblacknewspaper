                ...
                <div class="footer_column footer_link_column">
                    ...
                    <ul class="footer_list">
                        <li class="footer_list_item">
                            <a class="footer_list_link" href="http://localhost/student-life.html">Student Life</a>
                        </li>
                        <li class="footer_list_item">
                            <a class="footer_list_link" href="http://localhost/opinion.html">Opinion</a>
                        </li>
                        <li class="footer_list_item">
                            <a class="footer_list_link link_inactive" href="">Media</a>
                        </li>
                        <li class="footer_list_item">
                            <a class="footer_list_link" href="http://localhost/news.html">News</a>
                        </li>
                        <li class="footer_list_item">
                            <a class="footer_list_link" href="http://localhost/sports.html">Sports</a>
                        </li>
                        <li class="footer_list_item">
                            <a class="footer_list_link" href="http://localhost/arts-and-entertainment.html">Arts &amp; Entertainment</a>
                        </li>
                    </ul>
                </div>
                <div class="footer_column footer_link_column">
                    ...
                    <ul class="footer_list">
                        <li class="footer_list_item">
                            <a class="footer_list_link" href="http://localhost/archives.html">Archives</a>
                        </li>
                    </ul>
                </div>
