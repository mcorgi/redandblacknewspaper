...
function buildAccount() {
        ...
        '<div class="account_panel_wrapper">' +
            ...
            '<div class="account_section_section">' +
                '<ul class="section_container">' +
                    '<li class="account_link" data-link="http://localhost/bookmarks.html">Bookmarks</li>' +
                    '<li class="account_link" data-link="http://localhost/mailbox.html">Mailbox</li>' +
                    '<li class="account_link" data-link="http://localhost/my-data.html">My Data</li>' +
                '</ul>' +
            '</div>' +
    ...
    $('.account_link').bind('click', function(){
        ...
        if ($(this).attr('data-link') == "http://localhost/bookmarks.html" || $(this).attr('data-link') == "http://localhost/my-data.html" || $(this).attr('data-link') == "http://localhost/mailbox.html" || $(this).hasClass('sign_out')) {
            // nada for now
        }
        else {
...
function setAccount(){
    ...
    $('.account_link[data-link="http://localhost/bookmarks.html"]').hide();
    $('.account_link[data-link="http://localhost/mailbox.html"]').hide();
    $('.account_link[data-link="http://localhost/my-data.html"]').hide();
