...
function buildAccount() {
        ...
        '<div class="account_panel_wrapper">' + /*
            ...
            '<div class="account_section_section">' +
                '<ul class="section_container">' +
                    '<li class="account_link" data-link="https://www.whsredandblack.com/bookmarks.html">Bookmarks</li>' +
                    '<li class="account_link" data-link="https://www.whsredandblack.com/mailbox.html">Mailbox</li>' +
                    '<li class="account_link" data-link="https://www.whsredandblack.com/my-data.html">My Data</li>' +
                '</ul>' +
            '</div>' + */
    ...
    $('.account_link').bind('click', function(){
        ...
        if ($(this).attr('data-link') == "https://www.whsredandblack.com/bookmarks.html" || $(this).attr('data-link') == "https://www.whsredandblack.com/my-data.html" || $(this).attr('data-link') == "https://www.whsredandblack.com/mailbox.html" || $(this).hasClass('sign_out')) {
            // nada for now
        }
        else {
    ...
    $('.sign_out').bind('click', function(){
        ...
        posting.done(function() {
            ...
            window.location = 'https://www.whsredandblack.com/index.html';
